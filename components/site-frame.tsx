...
/*
 * ESCALA DE EMPILHAMENTO DO SITE — mexer num número aqui exige olhar os outros.
 *
 *     0–20   conteúdo de página
 *       30   barras fixas de página (a do painel da organização)
 *       40   cabeçalho do site, e tudo que mora dentro dele
 *       60   sobreposições que precisam cobrir o cabeçalho (ficha do jogador)
 *     9000   cerimônia de sorteio em tela cheia
 *
 * O cabeçalho tem `backdrop-filter`, e isso CRIA CONTEXTO DE EMPILHAMENTO: o menu da
 * conta lá dentro pede z-index 60, mas esse 60 só vale entre irmãos dentro do
 * cabeçalho. Contra o resto da página quem compete é o cabeçalho inteiro, com o número
 * dele. Foi assim que o menu da conta apareceu por baixo da barra do painel: as duas
 * estavam em 40, empate resolvido pela ordem do DOM, e a barra vinha depois.
 */
